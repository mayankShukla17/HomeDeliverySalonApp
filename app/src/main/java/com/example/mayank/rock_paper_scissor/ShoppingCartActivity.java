...
public class ShoppingCartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv1.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v){   Intent i=new Intent(ShoppingCartActivity.this,ShoppingCartActivity.class);}
        });
        ...
        bShop.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                final ProgressDialog progressDialog = new ProgressDialog(ShoppingCartActivity.this,
                        R.style.Theme_AppCompat_DayNight_Dialog_Alert);
                progressDialog.setIndeterminate(true);
                progressDialog.setMessage("Getting your stylists.....");
                ...
                new android.os.Handler().postDelayed(
                        new Runnable() {
                            public void run() {
                                ...
                                d.setContentView(R.layout.fragment_after_booking);
                                d.setTitle("BOOKING");
                                d.show();
